...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <div class="profile" style="width: 2rem;">

        <img src="../travel.png" width="50px"style="text-align:center" hieght="50px"alt="wandersahre"><h3 color="#4e255c">Geteway</h3>
        ...
        <div class="header">    
            <div class="header-content clearfix">
               ...
               <div class="text-center">
                <h2 class="pt-3">travel agency</h2>
                 </div>
